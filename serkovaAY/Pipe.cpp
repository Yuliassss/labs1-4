...
ostream& operator<<(ostream& out, const Pipe& p)
{
    ...
    out << "Информация о трубе \"" << p.km_mark << "\":\n"
        << symbol << " ID: " << p.id << "\n"
        << symbol << " Название: " << p.km_mark << "\n"
        << symbol << " Длина: " << p.length << " км" << "\n"
        << symbol << " Диаметр: " << p.diameter << " мм" << "\n"
